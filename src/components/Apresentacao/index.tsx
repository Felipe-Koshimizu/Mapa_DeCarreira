import foto from "../../assets/Imagem do WhatsApp de 2025-10-18 à(s) 21.13.28_ac2f5764.jpg"
        ...
        <div className="flex flex-col gap-8 flex-1">
            ...
            <div className="space-y-3">
                <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                    ...
                    <span className="text-sm">felipekoshimor@gmail.com</span>
                </div>

                <a
                    href="https://www.linkedin.com/in/felipe-trivia-koshimizu-90058721a/"
                    target="_blank"
                ...
                >
                    ...
                    <span className="text-sm">Felipe-Trivia-Koshimizu</span>
                </a>

                <a
                    href="https://github.com/Felipe-Koshimizu"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                >
                    ...
                    <span className="text-sm">Felipe-Koshimizu</span>
                </a>
            </div>
        </div>
    )
