import cvPdf from './docs/PROA - Felipe Trivia Koshimizu 2025.docx (1).pdf'
        ...
        <div className="space-y-6">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 border border-gray-200 dark:border-gray-700">
                <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
                    Me chamo Felipe Trivia Koshimizu, tenho 21 anos e sou natural do São Paulo-SP. 
                Atualmente, estou estudando no PROA e fazendo faculdade de Análise desenvolvimento de sistemas. Sou apaixonado por tecnologia e compartilho meu conhecimento com a comunidade.
            ...
            <a
                href={cvPdf}
                download="Felipe Trivia Koshimizu 2025.docx (1).pdf"
